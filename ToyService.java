...
public class ToyService {
    ...
    public void addToy(String name, String category, double price, int stock, String description, String imageUrl) {
        List<String> lines = FileHelper.readLines(FILE);
        int id = lines.size() + 1;
        String line = "T" + id + "|" + name + "|" + category + "|" + price + "|" + stock + "|" + description + "|" + imageUrl;
